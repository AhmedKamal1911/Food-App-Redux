...
import { columns } from "./user-transactions-table/columns";
import { UserTransactionsTable } from "./user-transactions-table/user-transactions-table";

import { TransactionOrder } from "@/lib/types/product";
type Props = {
  data: TransactionOrder[];
};
export default function TransactionsTableSection({ data }: Props) {
  ...
  return (
    <div>
      ...
      <div className="mt-4">
        <UserTransactionsTable columns={columns} table={table} />
        <PaginationControls
          page={page + 1}
          lastPage={lastPage}
